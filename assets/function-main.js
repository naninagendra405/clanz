...
$('.open-sidebar').on('click',function(){
	...
	$('.open-sidebar').css('background','#F6FF00').css('transform','translateX(-275px)');;
  ...
  $('.sidebar-full').css('right','-300px').css('opacity','0');
	...
	$('.open-sidebar i').css('color','#F6FF00').css('transform','rotate(0)');
...
$('.open-sidebar-left').on('click',function(){
	...
	$('.open-sidebar-left').css('background','#F6FF00').css('transform','translateX(275px)');;
	...
	$('.open-sidebar-left i').css('color','#F6FF00').css('transform','rotate(0)');
	$('.overlay').removeClass('active');
}
});
// ----------end---------
